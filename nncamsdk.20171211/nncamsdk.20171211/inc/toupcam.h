...
#define TOUPCAM_FLAG_PUTTEMPERATURE     0x00000800  /* support to put the temperature of sensor, target temperature of TEC */
...
#define TOUPCAM_FLAG_YUV422             0x10000000  /* pixel format, yuv422 */
...
}ALIGNED8 ToupcamModelV2; /* camera model v2 */
...
/*
    get the version of this dll/so/dylib, which is: 20.10565.20171211
*/
#ifdef _WIN32
...
#define TOUPCAM_OPTION_CG                   0x19    /* Conversion Gain: 0 = HCG, 1 = LCG, default: 0 */
...
#define TOUPCAM_PIXELFORMAT_YUV422          0x06
#define TOUPCAM_PIXELFORMAT_YUV444          0x07
#define TOUPCAM_PIXELFORMAT_RGB888          0x08
#define TOUPCAM_PIXELFORMAT_GMCY8           0x09
#define TOUPCAM_PIXELFORMAT_GMCY12          0x0a
...
This function is only available on macOS and Linux, it's unnecessary on Windows.
  ...
  (2) To process the device plug in / pull out in Linux / macOS, please call this function to register the callback function.
      When the device is inserted or pulled out, you will be notified by the callback funcion, and then call Toupcam_Enum(...) again to enum the cameras.
