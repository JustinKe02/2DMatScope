...
/*
    ...
    We use P/Invoke to call into the libnncam.so API, the c# class ToupCam is a thin wrapper class to the native api of libnncam.so.
...
namespace ToupTek
{
    ...
    {
        [DllImport("libnncam.so", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
    ...
    public class ToupCam : IDisposable
    {
        ...
        public enum eFLAG : ulong
        {
            ...
            FLAG_YUV422              = 0x10000000,   /* pixel format, yuv422 */
        ...
        [DllImport("libnncam.so", ExactSpelling = true, CallingConvention = CallingConvention.StdCall), Obsolete("Use Toupcam_EnumV2")]
        private static extern uint Toupcam_Enum(IntPtr ti);
        [DllImport("libnncam.so", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        private static extern uint Toupcam_EnumV2(IntPtr ti);
        [DllImport("libnncam.so", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        private static extern SafeHToupCamHandle Toupcam_Open([MarshalAs(UnmanagedType.LPStr)] string id);
        [DllImport("libnncam.so", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport("libnncam.so", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        private static extern int Toupcam_PullImageWithRowPitch(SafeHToupCamHandle h, IntPtr pImageData, int bits, int rowPitch, ut uint pnWidth, out uint pnHeight);
        [DllImport("libnncam.so", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        ...
        */
        ...
        [DllImport("libnncam.so", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        private static extern int Toupcam_put_ABBAuxRect(SafeHToupCamHandle h, ref RECT pAuxRect);
        [DllImport("libnncam.so", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        private static extern int Toupcam_get_ABBAuxRect(SafeHToupCamHandle h, out RECT pAuxRect);
        ...
        */
        [DllImport("libnncam.so", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        private static extern int Toupcam_get_Revision(HToupCam h, out ushort pRevision);
        ...
        */
        ...
        [DllImport("libnncam.so", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        private static extern int Toupcam_AbbOnePush(SafeHToupCamHandle h, PITOUPCAM_BLACKBALANCE_CALLBACK fnBBProc, IntPtr pBBCtx);
        ...
        [DllImport("libnncam.so", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        private static extern int Toupcam_put_InitWBGain(SafeHToupCamHandle h, ushort[] v);
