    ...
    */
    ...
    DECLARE_INTERFACE_(IToupcam, IUnknown)
    {
        ...
        */
        ...
        STDMETHOD(GetHistogram) (THIS_ PITOUPCAM_HISTOGRAM_CALLBACK fnHistogramProc, void* pHistogramCtx) PURE;            
        STDMETHOD(put_ExpoCallback) (THIS_ PITOUPCAM_EXPOSURE_CALLBACK fnExpoProc, void* pExpoCtx) PURE;
        STDMETHOD(get_AutoExpoEnable) (THIS_ BOOL* bAutoExposure) PURE;
        STDMETHOD(put_AutoExpoEnable) (THIS_ BOOL bAutoExposure) PURE;
        ...
        STDMETHOD(AwbInit) (THIS_ PITOUPCAM_WHITEBALANCE_CALLBACK fnWBProc, void* pWBCtx) PURE;
        STDMETHOD(put_AuxRect) (THIS_ const RECT* pAuxRect) PURE;
        STDMETHOD(get_AuxRect) (THIS_ RECT* pAuxRect) PURE;
        STDMETHOD(put_AuxRectShow) (THIS_ BOOL bShow) PURE;
        STDMETHOD(get_AuxRectShow) (THIS_ BOOL* bShow) PURE;
        STDMETHOD(put_VignetEnable) (THIS_ BOOL bEnable) PURE;
        STDMETHOD(get_VignetEnable) (THIS_ BOOL* bEnable) PURE;
        ...
        STDMETHOD(get_Chrome) (THIS_ BOOL* bChrome) PURE;
        /* monochromatic */
        STDMETHOD(put_Chrome) (THIS_ BOOL bChrome) PURE;
        ...
        */
        ...
        /* skip or bin */
        STDMETHOD(put_Mode) (THIS_ BOOL bSkip) PURE;
        STDMETHOD(get_Mode) (THIS_ BOOL* bSkip) PURE;
        STDMETHOD(put_ChromeCallback) (THIS_ PITOUPCAM_CHROME_CALLBACK fnChromeProc, void* pChromeCtx) PURE;
        ...
        STDMETHOD(AwbOnePush) (THIS_ PITOUPCAM_TEMPTINT_CALLBACK fnTTProc, void* pTTCtx) PURE;
        ...
        */
        ...
        /*
            ...
            TRUE: > 8 bits
        */
        STDMETHOD(get_BitDepth) (THIS_ BOOL* bBitDepth) PURE;
        STDMETHOD(put_BitDepth) (THIS_ BOOL bBitDepth) PURE;
        ...
        */
        ...
        /*
            ...
            return E_NOTIMPL if not supported
        */                    
        STDMETHOD(get_TEC) (THIS_ BOOL* bTEC) PURE;
        /*
            set the thermoelectric cooler status: on or off.
            return E_NOTIMPL if not supported
        */ 
        STDMETHOD(put_TEC) (THIS_ BOOL bTEC) PURE;
        ...
        */
        ...
        STDMETHOD(AbbOnePush) (THIS_ PITOUPCAM_BLACKBALANCE_CALLBACK fnBBProc, void* pBBCtx) PURE;
        ...
        */
        ...
        STDMETHOD(get_FfcStatus) (THIS_ int* status) PURE;
...
#define __ITOUPCAMSTILLIMAGE_DEFINED__
    /* most Touptek Camera DirectShow source filters has two output pins, one is pin category PIN_CATEGORY_PREVIEW, and the other is pin category PIN_CATEGORY_STILL.
        ...
        Please see the sample toupcamdemodshow.
    */
...
/* return value: camera model name, such as 'E3ISPM20000KPA' */
