...
/*
    ...
    We use P/Invoke to call into the nncam.dll API, the c# class ToupCam is a thin wrapper class to the native api of nncam.dll.
...
namespace ToupTek
{
    ...
    public class ToupCam : IDisposable
    {
        ...
        */
        ...
        [DllImport("nncam.dll", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        private static extern int Toupcam_put_BlackBalance(SafeHToupCamHandle h, [In] ushort[] aSub);
        [DllImport("nncam.dll", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        private static extern int Toupcam_get_BlackBalance(SafeHToupCamHandle h, [Out] ushort[] aSub);
        ...
        */
        [DllImport("nncam.dll", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        private static extern int Toupcam_get_Revision(SafeHToupCamHandle h, out ushort pRevision);
